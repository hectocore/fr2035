/*
	Author: Hector Corral (fork of Karel Moricky's code)
...
// Play music
0 fadeMusic 1;
playMusic "FR2035_LeadTrack01_F"; // Play main menu theme
addMusicEventHandler ["MusicStop", {0 fadeMusic 1; playMusic "FR2035_LeadTrack01_F"}]; // Repeat the music
